...
To post a job, you need to create a [job definition](/deployments/jobs/job-definition/intro) that describes what you want to run. The job definition is a JSON object that specifies container images, commands, and resource requirements.
...
// Learn more about job definition structure: /deployments/jobs/job-definition/intro
