...
The `ipfsHash` parameter should contain the IPFS hash of your [job definition](/deployments/jobs/job-definition/intro), which describes what container to run, what commands to execute, and what resources are needed.
