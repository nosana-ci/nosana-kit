...
Nosana is a fully permissionless network, which means you can run whatever model or workload you want! You can also find more examples and templates on [Nosana Templates](https://github.com/nosana-ci/pipeline-templates/tree/main/templates) on GitHub.

## Getting Started Examples

### [Hello World](/inference/examples/hello_world)
...
### [Ollama](/inference/examples/ollama)
