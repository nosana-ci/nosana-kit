...
export function getNosanaStakingErrorMessage(code: NosanaStakingError): string {
  if (process.env.NODE_ENV !== 'production') {
    return (nosanaStakingErrorMessages as Record<NosanaStakingError, string>)[code];
  }

  return 'Error message not available in production bundles.';
}

export function isNosanaStakingError<TProgramErrorCode extends NosanaStakingError>(
  error: unknown,
  transactionMessage: {
