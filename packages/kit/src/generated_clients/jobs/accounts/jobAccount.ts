...
export const JOB_ACCOUNT_DISCRIMINATOR = new Uint8Array([91, 16, 162, 5, 45, 210, 125, 65]);
...
export function getJobAccountCodec(): FixedSizeCodec<JobAccountArgs, JobAccount> {
...
export function decodeJobAccount<TAddress extends string = string>(
  ...
  return decodeAccount(encodedAccount as MaybeEncodedAccount<TAddress>, getJobAccountDecoder());
}
