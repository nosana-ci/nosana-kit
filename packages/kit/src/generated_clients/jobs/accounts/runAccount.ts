...
export const RUN_ACCOUNT_DISCRIMINATOR = new Uint8Array([194, 169, 110, 230, 235, 11, 225, 22]);
...
export function getRunAccountCodec(): FixedSizeCodec<RunAccountArgs, RunAccount> {
...
export function decodeRunAccount<TAddress extends string = string>(
  ...
  return decodeAccount(encodedAccount as MaybeEncodedAccount<TAddress>, getRunAccountDecoder());
}
