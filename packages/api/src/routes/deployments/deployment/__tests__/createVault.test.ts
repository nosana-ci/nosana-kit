...
describe('createVault', () => {
  ...
  it('should create a vault with address and methods', () => {
    const vault = createVault(global.TEST_MOCK_DEPLOYMENT.vault, global.TEST_DEPLOYMENT_ROUTE_CLIENTS_WITH_SIGNER);
  ...
  test('when provided, it should include created_at', () => {
    ...
    const vault = createVault(global.TEST_MOCK_DEPLOYMENT.vault, global.TEST_DEPLOYMENT_ROUTE_CLIENTS_WITH_SIGNER, createdDate);
