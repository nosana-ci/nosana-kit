...
export function getCloseAdminInstructionDataEncoder(): Encoder<CloseAdminInstructionDataArgs> {
...
export function getCloseAdminInstructionDataDecoder(): Decoder<CloseAdminInstructionData> {
  return getStructDecoder([
    ['discriminator', fixDecoderSize(getBytesDecoder(), 8)],
  ]);
}

export function getCloseAdminInstructionDataCodec(): Codec<
