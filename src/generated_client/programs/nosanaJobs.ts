...
export const NOSANA_JOBS_PROGRAM_ADDRESS =
  'nosJTmGQxvwXy23vng5UjkTbfv91Bzf9jEuro78dAGR' as Address<'nosJTmGQxvwXy23vng5UjkTbfv91Bzf9jEuro78dAGR'>;

export enum NosanaJobsAccount {
  MarketAccount,
  JobAccount,
  RunAccount,
}
...
export enum NosanaJobsInstruction {
  Open,
  Update,
  Close,
  CloseAdmin,
...
export type ParsedNosanaJobsInstruction<
  TProgram extends string = 'nosJTmGQxvwXy23vng5UjkTbfv91Bzf9jEuro78dAGR',
> =
  | ({
