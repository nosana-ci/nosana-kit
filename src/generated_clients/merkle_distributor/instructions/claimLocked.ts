...
export function getClaimLockedInstructionDataEncoder(): Encoder<ClaimLockedInstructionDataArgs> {
...
export function getClaimLockedInstructionDataDecoder(): Decoder<ClaimLockedInstructionData> {
  return getStructDecoder([
    ['discriminator', fixDecoderSize(getBytesDecoder(), 8)],
  ]);
}

export function getClaimLockedInstructionDataCodec(): Codec<
