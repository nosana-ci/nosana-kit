...
export function getSettingsAccountEncoder(): Encoder<SettingsAccountArgs> {
...
export function getSettingsAccountDecoder(): Decoder<SettingsAccount> {
...
export function getSettingsAccountCodec(): Codec<
  SettingsAccountArgs,
  SettingsAccount
> {
